#!/bin/bash
# PINTOS-P1: THREADS -- ITEMIZED PASS/FAIL TESTING SCRIPT rev. D
#   A collaborative effort to build a simple yet effective itemized pass/fail 
#   testing script for Pintos Project 1: Threads.
...
main () {
    ...
    echo ""
    echo "1.  Attempt to run:  make"
    echo "2.  If make was successful:  cd build"
    echo "3.  If make was successful,  run all uncommented tests in this script."
    echo ""
